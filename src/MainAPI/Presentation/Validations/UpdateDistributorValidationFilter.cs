...
public class UpdateDistributorValidationFilter: IActionFilter
    {
        public void OnActionExecuting(ActionExecutingContext context)
        {
            // Verificar se o DTO está presente nos argumentos da ação
            if (!context.ActionArguments.TryGetValue("dto", out var value) || value is not UpdateDistributorDto dto)
            {
